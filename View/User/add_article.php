                    ...
                    <form name="contactForm" id="contactForm" method="post" action="" autocomplete="off">
                        <fieldset class="row">
                            ...
                            <div class="column lg-12 form-field">
                                <input name="cWebsite" id="cWebsite" class="u-fullwidth h-remove-bottom" placeholder="title" value="" type="text">
                            </div>
                            
                            <div class="column lg-12 message form-field">
                                <textarea name="cMessage" id="cMessage" class="u-fullwidth" placeholder="description"></textarea>
                            </div>
                            
                            <div class="column lg-6 tab-12 form-field"  style="cursor: pointer;">
                                <input name="cName" id="cName" class="u-fullwidth h-remove-bottom" placeholder="Your Name" value="" type="file">
                            </div>
